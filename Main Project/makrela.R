...
opis=read.AnnotatedDataFrame("http://www.broadinstitute.org/mpr/publications/projects/LUNG/datasetA_scans.txt",sep="\t",header = TRUE,row.names=4,stringsAsFactors=F)



experiment=new("MIAME",name="dane mikromacierzowe",url="http://www.bioconductor.org",other=list(notes ="inne"))
exprset=new("ExpressionSet",expr=drma,phenoData=exprs,experimentData=experiment,annotation="gahgu95av2.db")
